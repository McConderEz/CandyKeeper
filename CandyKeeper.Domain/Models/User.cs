...
namespace CandyKeeper.Domain.Models
{
    public class User
    {
        ...
        private User(int id,string name, string passwordHashed,int? storeId = null, Store store = null)
        {
            Name = name;
        ...
        public static Result<User> Create(int id,string name, string passwordHashed, int? storeId = null, Store store = null)
        {
            ...
            var user = new User(id, name, passwordHashed, storeId, store);
