...
namespace CandyKeeper.DAL
{
    public class CandyKeeperDbContext : DbContext
    {
        ...
        //TODO: Сделать чтобы пользователь видел только продукты своего магазина и добавлял продукты ссылаясь на свой магазин
        //TODO: Обновлять счётчик пользователей
        
        //TODO: Сделать запросы по 5 и 6 лабе в коде
        
        //TODO: Сделать скрытие пароля
        
        //TODO: Сделать проверки корректности на форме добавление/редактирования записей
