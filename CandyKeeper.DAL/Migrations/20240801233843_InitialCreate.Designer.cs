...
namespace CandyKeeper.DAL.Migrations
{
    ...
    [Migration("20240801233843_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandyKeeper.DAL.Entities.ProductForSaleEntity", b =>
                {
                    ...
                    b.ToTable("ProductForSales", t =>
                        {
                            t.HasCheckConstraint("PriceConstraint", "Price >= 1");

                            t.HasCheckConstraint("VolumeConstraint", "Volume >= 0");
                        });
                });
            ...
            modelBuilder.Entity("CandyKeeper.DAL.Entities.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
