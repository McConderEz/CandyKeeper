        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    YearOfOpened = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Suppliers_OwnershipTypes_OwnershipTypeId",
                        column: x => x.OwnershipTypeId,
                        principalTable: "OwnershipTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDeliveries_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDeliveries_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreSupplierLink", x => new { x.StoresId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_StoreSupplierLink_Stores_StoresId",
                        column: x => x.StoresId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StoreSupplierLink_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductForSales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductForSales_ProductDeliveries_ProductDeliveryId",
                        column: x => x.ProductDeliveryId,
                        principalTable: "ProductDeliveries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductForSales_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductForSales_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDeliveries_StoreId",
                table: "ProductDeliveries",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDeliveries_SupplierId",
                table: "ProductDeliveries",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductForSales_ProductDeliveryId",
                table: "ProductForSales",
                column: "ProductDeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductForSales_ProductId",
                table: "ProductForSales",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductForSales_StoreId",
                table: "ProductForSales",
                column: "StoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreSupplierLink_SuppliersId",
                table: "StoreSupplierLink",
                column: "SuppliersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_OwnershipTypeId",
                table: "Suppliers",
                column: "OwnershipTypeId");
        }
